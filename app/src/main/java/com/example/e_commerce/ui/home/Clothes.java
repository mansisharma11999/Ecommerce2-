...
public class Clothes extends AppCompatActivity implements AddorRemoveCallbacks
{
    RecyclerView mRecyclerView;
    RecyclerAdapter mAdapter;
    String[] productNames={"Jeans","Tops","Kurti","Shirts"};
    int[] productImages={R.drawable.jeans,R.drawable.top,R.drawable.kurti,R.drawable.shirts};
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(Clothes.this,cart_count,R.drawable.google));
        //MenuItem menuItem2 = menu.findItem(R.id.notification_action);
        //menuItem2.setIcon(Converter.convertLayoutToImage(Clothes.this,2,R.drawable.ic_launcher_foreground));
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.cart_action:
                Intent i =new Intent(Clothes.this,cart.class);
                startActivity(i);
        }
