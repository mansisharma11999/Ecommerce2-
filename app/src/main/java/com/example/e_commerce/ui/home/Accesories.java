...
public class Accesories extends AppCompatActivity implements AddorRemoveCallbacks
{
    RecyclerView mRecyclerView;
    RecyclerAdapter mAdapter;
    String[] productNames={"Bags","Headphones","Earings"};
    int[] productImages={R.drawable.one,R.drawable.two,R.drawable.three};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Accesories");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(Accesories.this,cart_count,R.drawable.google));
        //MenuItem menuItem2 = menu.findItem(R.id.notification_action);
        //menuItem2.setIcon(Converter.convertLayoutToImage(Accesories.this,2,R.drawable.ic_launcher_foreground));
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.cart_action:
                Intent i =new Intent(Accesories.this,cart.class);
                startActivity(i);
        }
