...
public class Shoes extends AppCompatActivity implements AddorRemoveCallbacks {

    RecyclerView mRecyclerView;
    RecyclerAdapter mAdapter;
    String[] productNames={"Men's Shoes","Bellies","Women's Shoes"};
    int[] productImages={R.drawable.shoeone,R.drawable.shoetwo,R.drawable.shoethree};
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(Shoes.this,cart_count,R.drawable.google));
        //MenuItem menuItem2 = menu.findItem(R.id.notification_action);
        //menuItem2.setIcon(Converter.convertLayoutToImage(Shoes.this,2,R.drawable.ic_launcher_foreground));
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.cart_action:
                Intent i =new Intent(Shoes.this,cart.class);
                startActivity(i);
        }
